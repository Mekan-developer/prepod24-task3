<div class="w-[220px] mx-auto h-full">
    <div class="flex gap-1 p-4 @if($status == "default") bg-white shadow-md rounded-md @endif  ">
    ...
    <div class="flex gap-1 p-4  @if($status == "looking") bg-white shadow-md rounded-md @endif ">
